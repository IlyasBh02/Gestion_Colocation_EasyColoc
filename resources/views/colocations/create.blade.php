                ...
                <div class="p-8">
                    <form action="{{ route('colocations.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button>{{ __('Create Colocation') }}</x-primary-button>
                            <a href="{{ route('colocations.index') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition ease-in-out duration-150">
                                {{ __('Cancel') }}
                            </a>
                        </div>
                    </form>
